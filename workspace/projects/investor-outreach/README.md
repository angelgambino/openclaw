# Investor Outreach Project

**Owner:** Angel
**Status:** Waiting for investor database links
**Created:** 2026-03-17

## Overview
Review investor databases shared by Angel to select investors for three key events. Research each selected investor, compile contact/profile info, and draft personalized email invitations for Angel's review.

⚠️ **DO NOT send any emails. DO NOT contact any investors.** All drafts are for Angel's review only.
...
- **Role:** Breakout room hosts — matched to founders in their investor thesis
- **Co-presented with:** SeedLegals
- **Investor Profile:** Angel investors, pre-seed family offices, VCs, accelerators
- **Sectors:** Impact, Health & Wellness, Human Potential, Sports, Media & Entertainment, AI
- **Geography:** Anywhere in the US
- **Target:** 100 investors

### 3. Needle Investor Lunch
- **Date:** Thursday March 19 or Friday March 20, 2026 at noon
- **Location:** The Battery, San Francisco
- **Purpose:** Investors meet each other and Kiyan (Founder & CEO of Needle)
- **Investor Profile:** AI, martech, future of work, e-commerce, SMB investors
- **Geography:** California-based
- **Source:** Needle investor database + additional from other databases
- **Format:** Intimate lunch, minimum 12 investors
- **Confirmed so far:** 2 investors already accepted
- **Need:** 10+ more acceptances
- **Invite from:** Angel Gambino
- **URGENT:** Event is this week — prioritize this list first

### 4. Angel Capital Association — Angel Investing Summit
- **Investor Profile:** Same as Pitch Slam (Angels, pre-seed family offices, VCs, accelerators)
- **Sectors:** Impact, Health & Wellness, Human Potential, Sports, Media & Entertainment, AI
- **Geography:** Anywhere in the US
- **Target:** 100 investors
...
4. Compile selected investors into documents with:
   ...
   - Twitter/X handle
   - Email
5. Research each investor's website and social media
6. Draft highly personalized email invitations per event
