# AngelGambino.com + LinkedIn — v3 Designer Brief
## Optimized for: AI Hiring Managers + Investors + Founders + Event Bookers + UHNW
## Voice: The Matriarch with Rizz | AI-Native Operator
...
- Body: **Inter** (18px desktop, 16px mobile)
- Accent: **Inter Medium** (14px, uppercase, letter-spacing 2px)

### Rules
- Mobile-first, high whitespace (80px between sections)
- No gradients, no shadows, no clutter
- Sticky mobile CTA: "Book Advisory Call"
...
**RIGHT:**
Professional headshot. Not optional. Warm lighting, quiet luxury.

**MOBILE:** Headshot above headline. Both buttons above fold.
...
### 3. AS SEEN IN (Logo Bar)

Logos: WIRED, BBC, MTV, TEDx, [other press]
Grayscale, 40px height, centered
...
**Copy:**
> I build AI agent workflows that automate investor research, deal sourcing, content production, and fundraising operations — at a speed and scale that replaces entire teams. This is my operating model, not a side project.
**Button:** See How I Work → Hubble
...
|--------|--------|---------|
| Investor Database | **13,781** | investors mapped with AI in 5 days |
...
**Testimonial 2:**
> "This is the community where I'm most active. The curated contacts and introductions are everything."
...
**Background:** Ivory
**Layout:** Full-width TEDx video hero with play overlay
